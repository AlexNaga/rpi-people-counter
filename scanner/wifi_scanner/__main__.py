...
# def scan(adapter, scantime, dictionary, number, nearby, jsonprint, out, allmacaddresses, manufacturers, nocorrection, loop, sort, targetmacs, pcap):
def scan(adapter, scantime):
